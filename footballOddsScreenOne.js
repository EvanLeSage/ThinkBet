...
function getOdds() {
    ...
    let url = xanoUrl.toString() + 'bestfeaturedoddsbysport?sport_key_requested[]=americanfootball_nfl';
    ...
    request.onload = function() {
        ...
        if (request.status >= 200 && request.status < 400) {
            ...
            const cardContainerNFL = document.getElementById("odds-container-nfl")
            ...
            data.forEach(odd => {
                ...
                //else
                //{
                    cardContainerNFL.appendChild(card);
                //}
            })
        }
    }
