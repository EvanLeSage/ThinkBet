...
function getOdds() {
    ...
    let url = xanoUrl.toString() + 'bestfeaturedoddsbysport?sport_key_requested[]=baseball_mlb';
    ...
    request.onload = function() {
        ...
        if (request.status >= 200 && request.status < 400) {
            ...
            const cardContainerMLB = document.getElementById("odds-container-mlb")
            ...
            data.forEach(odd => {
                ...
                //else
                //{
                    cardContainerMLB.appendChild(card);
                //}
            })
        }
    }
